...
-----END RSA PRIVATE KEY-----'''
    ...
    await upload_folder_with_identity(host = host ,username = username ,machine_id = machine_id , kafka_broker= kafka_broker , kafka_topic= kafka_topic, local_path=local_path , remote_path= remote_path , password = None , private_key = private_key , auth_type = auth_type)
    return {"success" : "Done"}
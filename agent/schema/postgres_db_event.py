"""schema/postgres_db_event.py — Postgres health event -> postgres_db_events table."""
...
@dataclass
class PostgresDbEvent(BaseDbEvent):
    engine: str = "postgres"
    category: str = "postgres_health"
    ...
    SECTIONS: ClassVar[List[str]] = POSTGRES_SECTIONS
